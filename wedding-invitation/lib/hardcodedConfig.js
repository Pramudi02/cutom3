export const hardcodedConfig = {
  ...
  gallery: [
    ...
    { src: '/images/gallery-4.png', alt: 'Gallery Photo 4' }
  ],
  audioUrl: '',
  ...
  theme: {
    ...
    colorTextDark: '#52173a',
    colorBg: '#FFFBF7',
    colorSurface: '#FFFFFF',
    heroOverlayStart: 'rgba(233, 30, 99, 0.4)',
    heroOverlayEnd: 'rgba(233, 30, 99, 0.1)'
  },
  rsvp: {
  ...
  sectionBackgrounds: {
    hero: '/images/bg_hero_lotus.png',
    story: '/images/bg_hero_lotus.png',
    events: '/images/bg_events_lotus.png',
    gallery: '/images/lotus-gallery.png',
